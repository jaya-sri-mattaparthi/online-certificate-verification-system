...
TEMPLATE_PATH = os.path.join(BASE_DIR, "fcc.png")
OUTPUT_DIR = "Fcc_Certificates"
...
# COORDINATES
NAME_X, NAME_Y = 670, 330
COURSE_X, COURSE_Y = 640, 440
SERIAL_X, SERIAL_Y = 1280, 950
...
dataset = {
    "Web Development": web_names,
    "Java Development": java_names,
}
...
def generate_fcc_dataset():
    ...
    for course_title, name_list in dataset.items():
        ...
        for name in name_list:
            ...
            serial_id = f"F{global_counter:03d}"
